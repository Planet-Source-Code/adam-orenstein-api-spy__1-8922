...
'Adam Orenstein
'This module is not just for the spy it's got a lot of other cool stuff in it
'sorry, because given this it will probably be hard to follow
...
Public Sub AskForExit()
    Dim Answer
    Answer = MessageBox(0&, "Are you sure you want to exit?", "Exit?", 4)
    
    If Answer = vbYes Then
        Call sndStopSound(0&, 0&)
        End
    
    Else: If Answer = vbNo Then Exit Sub
